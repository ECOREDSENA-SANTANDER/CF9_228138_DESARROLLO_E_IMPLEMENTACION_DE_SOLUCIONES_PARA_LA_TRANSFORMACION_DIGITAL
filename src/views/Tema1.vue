    ...
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5
      .titulo-principal.color-acento-botones
        .titulo-principal__numero
          span 1
        h1 Lenguaje de programación orientado a objetos
      ...
      .row.fondo-gray.align-items-center.py-4.py-md-3
        .col-lg-12.col-12.px-lg-5.px-4
          .row.justify-content-center.mb-4(data-aos="fade-down")
        
          .mb-4.d-flex
            .d-flex.flex-wrap.align-items-center.pe-4.bg-img-blue(style="border-radius: 25px; padding: 10px")
              h3.col.px-4.mb-0.text-white(data-aos="fade-right") Una clase
              img.col-lg.d-none.d-lg-flex(src='@/assets/curso/temas/tema1/titulo.svg' style="max-width: 60px; left: 180px; position: absolute" data-aos="fade-left")
      
          .row.justify-content-center.align-items-center.d-flex
            .col-lg-8.col-9.mb-9.mg-lg-0
              p Es una lista genéricamente de cómo van a ser los objetos de un determinado tipo.  
              p Por ejemplo, una clase para personificar a animales puede llamarse ‘animal’ y poseer una serie de atributos, como ‘nombre’ o ‘clase de animal’ (que regularmente son propiedades) y una sucesión con las actuaciones que estos pueden tener, como comer o correr, y que a su vez se efectúan métodos de la clase siendo (funciones).
            .col-lg-4.col-3
              img.mb-lg-0.mb-3(alt="" src="@/assets/curso/temas/tema1/img03.svg")
      ...
      .mb-4.d-flex
        .d-flex.flex-wrap.align-items-center.pe-4.bg-img-blue(style="border-radius: 25px; padding: 10px")
          ...
          img.col-lg.d-none.d-lg-flex(src='@/assets/curso/temas/tema1/titulo.svg' style="max-width: 60px; left: 185px; position: absolute" data-aos="fade-left")
      ...
      .row.justify-content-center.align-items-center.mb-5
        .col-lg-7.col-10.mb-lg-4.mb-4(data-aos="fade-right")
          img(src="@/assets/curso/temas/tema1/img01.jpg")
        .col-lg-5.mb-lg-4(data-aos="fade-left")
          .bg-532.p-4
            p.mb-0 A partir de está clase se pueden crear las instancias, es decir, cuando la clase cuenta con memoria en el sistema operativo que va a operar sobre el software.<br><br> De está forma, se pueden crear las instancias para un Perro de nombre=”Yoni”  con una edad de “5” años o bien la representación de un gato de nombre=”Milu” y de edad=”1” año.  Los dos están a partir de la clase animal, pero son dos instancias diferentes. Por lo que al llamar a sus métodos logra poseer resultados diferentes. Los dos comparten la lógica de sus requerimientos funcionales, pero cada uno de forma independiente tiene su estado.
      ...
      .row
        .col-lg-7.col-md-12.col-12
            SlyderA(tipo="b").slider-a-custom.mb-6(data-aos="zoom-in-left")
      ...
      .mb-4.d-flex
        .d-flex.flex-wrap.align-items-center.pe-4.bg-img-blue(style="border-radius: 25px; padding: 10px")
          ...
          img.col-lg.d-none.d-lg-flex(src='@/assets/curso/temas/tema1/titulo.svg' style="max-width: 60px; left: 135px; position: absolute" data-aos="fade-left")

      p.mb-2 Es un lenguaje de programación orientado a objetos. Los cuatro principios básicos de la programación orientada a objetos son: Abstracción: modelar los atributos e interacciones pertinentes de las entidades como clases para definir una representación abstracta de un sistema.

        .row.fondo-pink.align-items-center.py-4.py-md-3
          .col-lg-12.col-12.px-lg-5.px-4
            .row.justify-content-center.mb-4(data-aos="fade-down")
                ...
                .col-lg-7.my-3
                  .bloque-texto-b.color-primario.p-4.mb-5
                    .bloque-texto-b__texto
                      i.fas.fa-quote-left
                      p.mb-2 <br>En lenguaje como C++ donde los mismos están diseñados dentro de la Programación orientada a Objetos, si dentro del programa a realizar todos los miembros de una clase son públicos y estáticos, en aquel momento equivalen a variables y funciones globales con el prefijo «NombreDeClase:»
                      h5.d-flex.justify-content-end <br>(Gervais, 2016).
                        i.fas.fa-quote-right
                  .bloque-texto-b.color-primario.p-4.mb-5
                    .bloque-texto-b__texto
                      i.fas.fa-quote-left
                      p.mb-2 <br>Definición de clases. Los datos de una clase se pueden guardar en una estructura. De hecho, en C++ un struct no es otra cosa que una clase con todos los miembros públicos. Como C no permite métodos, usamos funciones globales. El equivalente de C++. 
                      h5.d-flex.justify-content-end <br>(Sierra, 2015) 
                        i.fas.fa-quote-right
                
      .mb-4.d-flex
        .d-flex.flex-wrap.align-items-center.pe-4.bg-img-blue(style="border-radius: 25px; padding: 10px")
          h3.col.px-4.mb-0.text-white(data-aos="fade-right") #[em JAVA (SE,EE)]
          img.col-lg.d-none.d-lg-flex(src='@/assets/curso/temas/tema1/titulo.svg' style="max-width: 60px; left: 220px; position: absolute" data-aos="fade-left")

      p Oracle Java es la plataforma de lenguaje de programación y desarrollo, que reduce costos, acorta los plazos de desarrollo, impulsa la innovación y mejora los servicios de las aplicaciones, conozcamos más:
      .row
        .col-md-7.mb-4.mb-md-0
          AcordionA(tipo="b" clase-tarjeta="tarjeta tarjeta--gris")
            .row(titulo="Plataforma informática Java")
              .col-lg-6.ps-5
            ...
            .row(titulo="Evoluciones")
              .col-6.ps-5
                ul.lista-ul--color.lista-acento-botones.mb-0
                  li.mb-0.d-flex 
              p.mb-0 Ha tenido constantes evoluciones desde sus inicios, Java nace en 1991 con el nombre “OAK”, posteriormente cambiado por Green por problemas legales, y finalmente con la denominación actual JAVA.<br><br>El objetivo de Java era crear un lenguaje de programación parecido a C++ en estructura y sintaxis, fuertemente orientado a objetos, pero con una máquina virtual propia.
            ...
            .row(titulo="Sitio web Java.com")
              .col-6.ps-5
                ul.lista-ul--color.lista-acento-botones.mb-0
                  li.mb-0.d-flex 
              p.mb-0 Oracle Java está disponible en el Acuerdo de licencia de Oracle Technology Network para Oracle Java SE. Esta licencia permite utilizar Java con fines personales y de desarrollo de forma gratuita.<br><br>Java 18 (Oracle JDK 18) ofrece miles de mejoras en cuanto a rendimiento, estabilidad y seguridad, incluyendo nueve propuestas de mejora de la plataforma, impulsando así aún más la productividad de los desarrolladores.
          ...
          AcordionA(tipo="b" clase-tarjeta="tarjeta tarjeta--gris")    
            ...
            .row(titulo="Aplicación de uso personal")
              .col-6.ps-5
                ul.lista-ul--color.lista-acento-botones.mb-0
                  li.mb-0.d-flex 
              p.mb-0 Si quiere descargar la aplicación de uso personal es gratuita donde se contará con todos los kits de desarrollo y herramientas útiles y compatibles. Para instalar java puede consultar el siguiente tutorial en línea:<br><br>https://www.java.com/es/download/help/windows_manual_download.html.<br><br> En la plataforma Link: https://www.jdoodle.com/online-java-compiler/
      ...
      .row.fondo6.align-items-center.py-4.py-md-3
        .col-lg-12.col-12.px-lg-5.px-4
          ...
          p.mb-0 Es un lenguaje de código abierto muy reconocido sobre todo para el desarrollo web ya que el mismo puede ser fácilmente incrustado en HTML, una de las grandes ventajas es su simplicidad para aquellos desarrolladores principiantes, por medio de este lenguaje se generan páginas web dinámicas que frecuentemente su contenido cambia, debemos tener en cuenta que las páginas webs estáticas son las que sus contenidos permanecen siempre igual.<br><br>
          p El esquema de php funciona mediante una petición al servidor el mismo recibe la información necesaria realizando las consultas a bases de datos, otros servidores u otras páginas web, el servidor responde si es una página web normal estática, pero donde el diseño y creación del mismo ha sido dinámico.
          .row.justify-content-center.align-items-start.mb-0
            .col-lg-10
              img.img-a.img-t.mb-5(data-aos="zoom-in")(src='@/assets/curso/temas/tema1/php.png', alt='')
      .mb-5
      .mb-4.d-flex
        .d-flex.flex-wrap.align-items-center.pe-4.bg-img-blue(style="border-radius: 25px; padding: 10px")
          h3.col.px-4.mb-0.text-white(data-aos="fade-right") #[em Ruby]
          img.col-lg.d-none.d-lg-flex(src='@/assets/curso/temas/tema1/titulo.svg' style="max-width: 60px; left: 140px; position: absolute" data-aos="fade-left")
      
      
      p.mb-5 #[em Ruby] es un lenguaje de programación interpretado, abstraído y orientado a objetos su licencia es distribuida bajo #[em software] libre, todos los tipos de datos son con objeto, clases, métodos, es descrito como un lenguaje multiparadigma, permitiendo programación procedimental.  

      .row.align-items-center.justify-content.my-1(data-aos="zoom-in-left")
        .col-lg-7.col-md-10.col-12.my-5
          .bloque-texto-b.color-secundario.bt.mx-6
            .bloque-texto-b__texto
              i.fas.fa-quote-left
              p.my-0 Se utiliza en su mayoría en el desarrollo de aplicaciones #[em web], pero también se utiliza para otros tipos de desarrollo en streaming. #[em Ruby] maneja estrechamente el paradigma de #[em POO,] así que estas variables son privadas y no logran verse desde fuera de la clase, toda comunicación que se realiza entre objetos se hace con los métodos. Se caracteriza por un lenguaje dinámico, ya que los programas en #[em Ruby] no se compilan, todo el código de clases, módulos y métodos se realiza por medio de un intérprete.
              h5.my-0.d-flex.justify-content-end (Cupul, 2021).
                i.fas.fa-quote-right
        .col-lg-5.my-3
          img.img-a.img-t(data-aos="zoom-in")(src='@/assets/curso/temas/tema1/ruby.png', alt='')
      
      .row.justify-content(data-aos="zoom-in-left")
        .col-lg-5
          .tarjeta.color-primario.p-3.mb-5
            .row.justify-content-around.align-items-center
              .col-lg-4.col-sm-2.col-lg-2
                img(src="@/assets/curso/temas/tema1/ruby2.svg")
              .col
                .row.justify-content-between.align-items-center
                  .col.mb-3.mb-sm-0
                    h3.mb-1 Editor en línea
                    a.anexo.mb-0.mb-lg-0(href="https://replit.com/languages/ruby" target="_blank")
                      .anexo__icono
                        img(src="@/assets/template/icono-link.svg")
                      .anexo__texto.text-wrap.text-break
                        p <b>Enlace web</b>. Code, create, and learn together with Ruby
                    p.mb-0 Programa: puts ‘Hello, world!’
                    
      
      .mb-4.d-flex
        .d-flex.flex-wrap.align-items-center.pe-4.bg-img-blue(style="border-radius: 25px; padding: 10px")
          h3.col.px-4.mb-0.text-white(data-aos="fade-right") #[em Python]
          img.col-lg.d-none.d-lg-flex(src='@/assets/curso/temas/tema1/titulo.svg' style="max-width: 60px; left: 160px; position: absolute" data-aos="fade-left")
          ...
          .bloque-texto-b.python.color-secundario.p-4
            .bloque-texto-b__texto
              ...
              p.mb-2 #[em Python] es un lenguaje de programación considerablemente utilizado en la mayor parte de las aplicaciones #[em web,] al realizar programas empresariales, la ciencia de datos y el #[em machine learning (ML).] Los programadores utilizan #[em Python] porque es eficientemente muy fácil de aprender, además de que se puede ejecutar en diferentes plataformas. El #[em software Python] es gratuito, se integra bien a todos las características de sistemas y aumenta la velocidad del desarrollo.
                h5.d-flex.justify-content-end <br>(S & G, 2018)
                  i.fas.fa-quote-right
      p Las empresas requieren programadores expertos en #[em Python] esto debido que es más fácil con tecnologías emergentes como:
